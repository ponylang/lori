...
- Replace ponylang/ssl dependency with lori's own SSL types ([PR #401](https://github.com/ponylang/lori/pull/401))
...
- Require explicit connection-failure handling for client connections ([PR #379](https://github.com/ponylang/lori/pull/379))
...
- Deliver a send's token through _on_send_accepted ([PR #346](https://github.com/ponylang/lori/pull/346))
...
- Require ponyc 0.67.0 to fix a possible write hang under load ([PR #338](https://github.com/ponylang/lori/pull/338))
...
- Require ponyc 0.64.0 or later ([PR #289](https://github.com/ponylang/lori/pull/289))
